    ...
    >
      ...
      <div className="space-y-10 px-0 md:px-10">
        <h4 className="text-4xl font-semibold">
          Here are{" "}
          <span className="underline decoration-[#F7AB0A]">somethings</span> you
          should know!
        </h4>
        <p className="text-sm">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti
          consectetur dolor eligendi dolore sapiente. Neque repellendus dolores
          temporibus suscipit, tempore iusto, ab labore possimus eaque eos
          eveniet consequatur! Accusamus, laborum.
        </p>
      </div>
    </motion.div>
  );
